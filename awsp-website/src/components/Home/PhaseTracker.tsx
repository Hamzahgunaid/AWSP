        ...
        <div className="phase-intro-grid" style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              fontSize: 'clamp(2rem, 3.4vw, 3.2rem)', lineHeight: 1.05, marginTop: '16px',
            }}>
              {isAr
          ...
          <div>
            <div style={{
              ...
              borderRadius: 'var(--radius-lg)', padding: '24px 28px', marginTop: '28px',
            }}>
              {[
                ...
                <div style={{
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      ...
                      <h3 style={{
                        fontFamily: isAr ? 'var(--font-arabic)' : 'var(--font-serif)',
                        fontSize: '1.35rem', margin: '0 0 8px', letterSpacing: '-0.01em',
                        color: 'var(--ink-800)',
                      }}>
