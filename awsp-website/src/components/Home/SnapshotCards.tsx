...
const SNAPSHOTS = [
  {
    href: '/projects',
    icon: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" style={{ width: 28, height: 28 }}>
        <path d="M4 8 L12 5 L20 8 L28 5 L28 24 L20 27 L12 24 L4 27 Z"/>
        <path d="M12 5 L12 24 M20 8 L20 27"/>
        <circle cx="22" cy="14" r="3.2"/><path d="M22 17.2 L22 21"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" style={{ width: 28, height: 28 }}>
        <path d="M9 8 L9 27 L23 27 L23 13 L18 8 Z"/>
        <path d="M18 8 L18 13 L23 13"/>
        <path d="M12 17 L20 17 M12 21 L20 21 M12 24 L17 24"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" style={{ width: 28, height: 28 }}>
        <path d="M5 13 L5 19 L11 19 L21 25 L21 7 L11 13 Z"/>
        <path d="M21 11 C 24 12, 24 20, 21 21"/>
        <path d="M9 19 L9 25 L13 25 L13 22"/>
      </svg>
    ),
